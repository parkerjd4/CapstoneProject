...
# Technology:
   The tools that I will be using will be Visual Studio 2017 and GitHub. The languages I will be using will be C/C++, C#, and maybe PHP. This will be a Desktop application. I will create tests using the built-in plugins of Visual Studio. Visual Studio will auto format the code.
