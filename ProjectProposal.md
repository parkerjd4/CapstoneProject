...
# Technology:
   The tools that I will be using will be Visual Studio 2017 and GitHub. I will create tests using the built-in plugins of Visual Studio. Visual Studio will auto format the code.
